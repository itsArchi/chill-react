...
const ContinueWatching = (props) => {
  ...
  return (
    <div className="relative min-w-[309px] sm:w-[309px] h-full sm:h-[162px] gap-6 sm:gap-2.5">
      <NewEpisode itemHide={hideItemText} />
      <img
        className="rounded-lg w-[309px] sm:w-[299px] h-[172px] sm:h-[162px] object-cover"
        src={image}
        alt=""
      />
      <div
