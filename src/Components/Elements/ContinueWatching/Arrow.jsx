const Arrow = () => {
  return (
    <div>
      ...
      <div className="absolute w-11 h-11 bg-[#2F3334] border border-solid border-[#E7E3FC3B] rounded-full flex justify-center items-center p-2.5 gap-2.5 -right-11 top-[50%] -translate-y-1/2">
